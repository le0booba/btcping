    ...
    <div className="bg-[#111111] border border-gray-800 p-5 rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
        <input
          ...
          className="flex-grow bg-black border border-gray-700 rounded-md px-4 py-2 focus:ring-2 focus:ring-white focus:outline-none transition-shadow text-white"
          disabled={isLoading}
        />
        <button
          type="submit"
